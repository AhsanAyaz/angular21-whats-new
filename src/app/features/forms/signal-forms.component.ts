          ...
          <div class="border p-4 rounded-box border-primary bg-primary/5">
            ...
            <div class="form-control w-full max-w-xs">
              ...
              <input
                ...
                [class.input-error]="!signalForm.username().valid()"
              />
              @if (!signalForm.username().valid()) {
            ...
            <div class="form-control w-full max-w-xs mt-2">
              ...
              <input
                ...
                class="input input-bordered input-primary w-full max-w-xs"
                [class.input-error]="!signalForm.email().valid()"
              />
              @if (!signalForm.email().valid()) {
...
email.valid(): {{ signalForm.email().valid() }}</code></pre>
              ...
              <button class="btn btn-sm btn-outline btn-accent mt-2" (click)="programmaticUpdate()">
                Simulate API Update
              </button>
            </div>
          </div>
